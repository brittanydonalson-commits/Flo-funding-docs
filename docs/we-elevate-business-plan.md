# We Elevate
## Business Plan — Transitional Living Center for Women in Transition

---

**Organization:** We Elevate (501(c)(3) nonprofit in formation)
**Location:** Cameron, Texas (Milam County)
**Founded:** 2026
**Founder:** Brittany
...
### Core Values
- **Dignity** — Every woman deserves respect
...
### The Gap We Fill
- **Existing shelters** → Focus on domestic violence
- **Homeless services** → General population, not this specific need
- **Our niche** → Financially stranded divorcees/widows NOT escaping violence

This is a **documented gap** in the housing assistance ecosystem.
...
### Who We Serve
- Women who were housewives/stay-at-home mothers
- Going through divorce OR widowed
- No independent income, no employment history
- May have children
- No other support system

### Exclusions (Clear Boundaries)
- Women with active violent situations (refer to DV shelters)
- Women with severe addiction (refer to treatment centers)
- Women with severe mental health crises (refer to appropriate care)

### Admission Criteria
1. Women 18+ with children or dependents
2. Financially stranded (no income or <$1,000/month)
3. Willing to participate in program
4. Background check (no violent offenses)
5. Referral from social worker, church, or self-referral

---

## 5. Program Design

### Housing (Campus Model)
...
- Full-time employment or enrollment
...
(To be formed)
- 3-5 members minimum
- Diversity: legal, financial, social work, community
...
- Churches (primary referral source)
- Legal aid societies
- DV shelters (for our niche)
...
| Item | Estimate |
|------|----------|
| Utilities (electric, water, internet) | $800 |
| Food (residents + staff) | $2,000 |
| Maintenance | $500 |
| Insurance | $300 |
| Supplies | $400 |
| Marketing | $200 |
...
- Partner with counties for replication
...
|------|------------|--------|------------|
| Land not secured | Medium | High | Church outreach, multiple approaches |
| Funding delays | High | High | Start small, phase build-out |
| Low enrollment | Medium | High | Strong outreach, referral partnerships |
| Staff turnover | Medium | Medium | Volunteer cultivation, clear roles |
| Regulatory issues | Low | High | Early county engagement, legal counsel |
...
## 12. Key Documents Needed

- [ ] 501(c)(3) determination letter
- [ ] Board of Directors formed
- [ ] Bylaws
- [ ] Site control (lease/donation agreement)
- [ ] Zoning approval
- [ ] Insurance
